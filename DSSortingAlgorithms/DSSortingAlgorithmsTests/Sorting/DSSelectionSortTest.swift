...
class DSSelectionSortTest: XCTestCase {
    ...
    let selectionSort = DSSelectionSort()
    ...
    func testSelectionSortSuccess() {
        selectionSort.sort(&inputArray)
        XCTAssertEqual(inputArray, sortedArray)
    }
    
    
    func testSelectionSortForReturnTypeSuccess() {
        let results = selectionSort.sort(inputFloatArray)
        XCTAssertEqual(results, sortedFloatArray)
    }
    
    func testReverseSelectionSortSuccess() {
        
        let results = selectionSort.reverse(inputArray)
